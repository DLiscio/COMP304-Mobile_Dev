...
import com.damien.damienliscio_comp304lab3_ex1.views.AddLocation
import com.damien.damienliscio_comp304lab3_ex1.views.WeatherDisplay

@OptIn(ExperimentalMaterial3Api::class)
class ViewLocationActivity : ComponentActivity() {
                        ...
                        TopAppBar(
                            {
                                Column(
                                    ...
                                    Text(text = "Weather Details", fontSize = 16.sp)
                                }
                            }
                        )
